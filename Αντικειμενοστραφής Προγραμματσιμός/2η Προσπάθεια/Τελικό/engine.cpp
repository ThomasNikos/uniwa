...
void engine::start(){
        ...
        }while(map[malfois.gety()][malfois.getx()] == '*');
            map[malfois.gety()][malfois.getx()] = 'L';
        mpampis poteridis(map);
        do{
            poteridis.setx(rand() % (width));
            poteridis.sety(rand() % (height));
        }while(map[poteridis.gety()][poteridis.getx()] == '*' || map[poteridis.gety()][poteridis.getx()] == 'L');
            map[poteridis.gety()][poteridis.getx()] = 'M';
        gem game_gem(map);
        do{
            game_gem.setx(rand() % (width));
            game_gem.sety(rand() % (height));
        }while(map[game_gem.gety()][game_gem.getx()] == '*' || map[game_gem.gety()][game_gem.getx()] == 'L' || map[game_gem.gety()][game_gem.getx()] == 'M');
        ...
        do{
            ...
            int c = getch();
            if(check_move(c, malfois.gety(), malfois.getx())){
                if(malfois.get_move(c)){
                    map[malfois.gety()][malfois.getx()] = 'L';
                    map[poteridis.gety()][poteridis.getx()] = ' ';
                    poteridis.domove(game_gem.getx(), game_gem.gety());
                    map[poteridis.gety()][poteridis.getx()] = 'M';
        ...
        clear();
        if((game_gem.gety() == malfois.gety() && game_gem.getx() == malfois.getx()) && (map[game_gem.gety()][game_gem.getx()] == 'M')){
