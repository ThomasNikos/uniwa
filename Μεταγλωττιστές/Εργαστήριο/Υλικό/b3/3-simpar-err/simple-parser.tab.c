...
{
      10,     0,    -1,    10,    11,     8,    -1,    10,    15,     8,
      -1,    10,     1,     8,    -1,    10,     8,    -1,    -1,    12,
      13,     4,    -1,     3,    -1,     6,    -1,     7,    -1,     6,
      -1,    13,     5,    14,     4,    -1
};
...
{
  "$end", "error", "$undefined", "SINT", "SEMI", "ASSIGNOP", "IDENTIFIER",
  "INTCONST", "NL", "$accept", "program", "decl", "type", "aid", "tim",
  "assign", 0
};
#endif
...
{
       0,    10,     0,     1,     3,     6,     8,    11,    12,    13,
      15,     8,     8,    13,     5,     8,     4,     6,     7,    14,
       4
};
...
/* Line 1464 of yacc.c  */
#line 68 "simple-parser.y"
    {
			if (!strcmp((yyvsp[(3) - (4)]), "SINT"))
			{
