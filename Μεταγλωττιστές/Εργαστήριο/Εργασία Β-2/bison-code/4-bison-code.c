...
{
      16,     0,    -1,    16,    17,    10,    -1,    -1,     3,    -1,
       4,    -1,    17,     5,    17,    -1,    17,     6,    17,    -1,
      17,     7,    17,    -1,    17,     8,    17,    -1,     6,    17,
      -1,    17,     9,    17,    -1,    11,    17,    12,    -1
};
...
{
  "$end", "error", "$undefined", "INTCONST", "VARIABLE", "PLUS", "MINUS",
  "TIMES", "DIVIDE", "POWER", "NEWLINE", "LEFT", "RIGHT", "END", "NEG",
...
{
       3,     0,     1,     4,     5,     0,     0,     0,    10,     0,
       0,     0,     0,     0,     0,     2,    12,     6,     7,     8,
       9,    11
};
...
{
      -9,     0,    -9,    -9,    -9,    14,    14,    29,    -8,    21,
      14,    14,    14,    14,    14,    -9,    -9,    15,    15,    -8,
      -8,    -8
};
...
{
       2,    14,     0,     3,     4,     0,     5,     8,     9,     0,
       0,     6,    17,    18,    19,    20,    21,     3,     4,     0,
       5,     0,    12,    13,    14,     6,    10,    11,    12,    13,
      14,     0,     0,    16,    10,    11,    12,    13,    14,    15
};

static const yytype_int8 yycheck[] =
{
       0,     9,    -1,     3,     4,    -1,     6,     5,     6,    -1,
      -1,    11,    10,    11,    12,    13,    14,     3,     4,    -1,
       6,    -1,     7,     8,     9,    11,     5,     6,     7,     8,
       9,    -1,    -1,    12,     5,     6,     7,     8,     9,    10
};
...
{
       0,    16,     0,     3,     4,     6,    11,    17,    17,    17,
       5,     6,     7,     8,     9,    10,    12,    17,    17,    17,
      17,    17
};
...
int yylex() {
        ...
        if (c == '-')
	{
        ...
        if (c == '*')
	{
		printf("\tScanner returned: TIMES (%c)\n", c);
		return TIMES;
	}

        if (c == '/')
	{
		printf("\tScanner returned: DIVIDE (%c)\n", c);
		return DIVIDE;
	}		

        if (c == '^')
	{
		printf("\tScanner returned: POWER (%c)\n", c);
		return POWER;
	}	

        if (c == '(')
	{
		printf("\tScanner returned: LEFT (%c)\n", c);
		return LEFT;
	}

        if (c == ')')
	{
		printf("\tScanner returned: RIGHT (%c)\n", c);
		return RIGHT;
	}		
