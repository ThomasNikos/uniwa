...
%token DELIMITER IDENTIFIER KEYWORD STRING INTEGER FLOAT PLUS MOD MINUS TIMES DIVIDE PLUS_ASSIGN MINUS_ASSIGN TIMES_ASSIGN DIVIDE_ASSIGN NEG POWER COMMENT UNKNOWN_TOKEN NEWLINE
%token PRINT LEFT_PT RIGHT_PT SEMICOLON ASSIGNOP CMP_OPERATOR TYPE SCAN LEN CMP COMMA FUNC LEFT_BR RIGHT_BR 
%token IF WHILE FOR RETURN DOUBLE_PLUS DOUBLE_MINUS LOGIC_OPERATOR LOG_NOT RIGHT_AR LEFT_AR AMPERSAND BACKSLASH_NEWLINE
