...
def main():
    ...
    **** έναρξη αναζήτησης
    ...
    if (bfs_steps > dfs_steps and astar_steps > dfs_steps) or (dfs_steps == bfs_steps) or (dfs_steps == astar_steps):
        print("DFS Better Method with " + str(dfs_steps) + " steps!")

    if (dfs_steps > bfs_steps and astar_steps > bfs_steps) or (astar_steps == bfs_steps) or (dfs_steps == bfs_steps):
        print("BFS Better Method with " + str(bfs_steps) + " steps!")
    
    if (bfs_steps > astar_steps and dfs_steps > astar_steps) or (astar_steps == dfs_steps) or (bfs_steps == astar_steps):
        print("A* Better Method with " + str(astar_steps) + " steps!")
